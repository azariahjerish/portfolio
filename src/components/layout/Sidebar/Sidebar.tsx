...
export function Sidebar() {
  ...
  useEffect(() => {
    if (window.innerWidth > 900 || !active) return;
    ...
    <aside className={styles.sidebar} aria-label="Site navigation">
      ...
      <div className={styles.identity}>
        {/* <div className={styles.avatarRing}>
          <div className={styles.avatarInitials}>AJ</div>
        </div> */}
        <div className={styles.headerTop}>
          <div>
            <h1 className={styles.name}>
              {profile.name}
              {profile.available && <span className={styles.mobileDot} aria-hidden="true" />}
            </h1>
        ...
        {profile.available && (
          <div className={styles.availableBadge} aria-label="Open to work">
